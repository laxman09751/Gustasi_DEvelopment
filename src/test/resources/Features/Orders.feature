...
#
  #Scenario: Orders pizza and paying with card
    #Given User enters to the url
    #When user enter the mobile "1231233211"
    #And user enter pass "Gustasi@1"
    #And User clicked login button
...
#
  #Scenario: Orders pizza and paying with card
    ...
    #And User clicks on Menu button
    #And User press Escape key
    #And user selects the pizza items clicks on the room and select room no101 and click on create order
    #And user clicks on settlenow button
    #And user pays with cash
#
  #Scenario: Orders pizza and paying with Airtel Money
    #Given User enters to the url
    #When user enter the mobile "1231233211"
    #And user enter pass "Gustasi@1"
    #And User clicked login button
    ...
    #And user selects the pizza items
    #And user clicks on settlenow button
    #And user pays with Airtel Money
#
  #Scenario: Orders pizza and paying with Airtel Money
    #Given User enters to the url
    #When user enter the mobile "1231233211"
